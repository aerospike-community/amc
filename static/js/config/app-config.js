...
//            {name: 'priority', width: 60, align: 'center', resizable: false, sortable: true, title: 'Disk Usage'},
        ...
        nodeColumnNames: ['', 'Host : Port', 'Build</br> Version', 'Cluster</br> Size', 'Disk', 'RAM', 'Cluster Name', 'Master and Replica</br> Objects', 'Master and Replica</br> Tombstones', 'Client</br> Connections', 'Migrates</br> Incoming', 'Migrates</br> Outgoing'],
        nodeListColumn: [
