...
// LogoutAuthInternalServerError runs the method Logout of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func LogoutAuthInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AuthController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "AuthTest"), rw, req, prms)
	logoutCtx, _err := app.NewLogoutAuthContext(goaCtx, req, service)
	if _err != nil {
...
// LogoutAuthNoContent runs the method Logout of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func LogoutAuthNoContent(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AuthController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
